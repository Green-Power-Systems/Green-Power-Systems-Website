      ...
      <div className="rts-about-area-start-h3-soalri rts-section-gap bg-lighten">
        <div className="bottom-left-img images">
          <Image
            ...
            width={500} // Adjust based on original design
            height={500}
          />
        </div>
              ...
              <div className="about-lefta-area-solari-2 pb--150">
                <div className="thumbnail-image-lg">
                  <Image
                    ...
                    width={600}
                    height={800}
                    priority // This is likely a primary image
                  />
                </div>
            ...
            <div className="col-lg-6 pl--110 pl_sm--15 mt_sm--80 pl_md--15">
              <div className="about-area-solari-3-right">
                <div className="solari-title-area-three">
                  <span className="pre-title skew-up">About Us</span>
                  <h2 className="title skew-up">
                    We believe solar, EVs, and clean water should be accessible
                  </h2>
                </div>
                <div className="inner-content">
                  ...
                  <div className="author-button-area">
                    ...
                    <div className="author-area">
                      <div className="thumbnail w-32 h-32 overflow-hidden rounded-full relative">
                        <Image
