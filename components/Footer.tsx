            ...
            <div className="single-footer-one-wrapper two">
              <div className="single-footer-component first">
                ...
                <div className="body mt--45">
                  <p className="disc">
                    Solari is a leading solar company dedicated <br />
                    to revolutionizing the way we generate and <br />
                    consume energy.
                  </p>
                ...
                <div className="body">
                  ...
                  <div className="footer-contact-wrapper-2">
                    ...
                    <div className="contact-single">
                      ...
                      <div className="info-content ml-dec-5">
                        <a href="tel:+4733378901">
                          <h6 className="title">+23 5825-32535</h6>
                        </a>
                    ...
                    <div className="contact-single">
                      ...
                      <div className="info-content">
                        <a href="mailto:someone@example.com">
                          <h6 className="title">dril.sola@gmail.com</h6>
                        </a>
                    ...
                    <div className="contact-single">
                      ...
                      <div className="info-content">
                        <a href="#">
                          <h6 className="title">1058 Helton Ave, Stky</h6>
                        </a>
