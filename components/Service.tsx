          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="solari-title-area-three text-center">
                ...
                <h2 className="title skew-up">Green Power Solutions</h2>
                <p className="disc skew-up">
                  Green Power Systems is dedicated to assembling, selling,
                  supporting,
                  <br />
                  and promoting electric vehicles while striving for
                ...
                >
                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-6 pl--60 pl_md--20 pl_sm--10 mt_sm--50">
                        <div className="inner-content-service-right-solari">
                          ...
                          <p className="disc">
                            Our comprehensive renewable energy services are
                            designed
                            <br />
                            to provide you with reliable, efficient, and
                            sustainable solutions in Solar, Electric Vehicles &
                            Buses, Fast Chargers, and Water Purification.
                          </p>
                          <p className="disc">
                            We offer customized solar energy solutions for
                            homeowners, helping them harness the power of the
                            sun to generate clean and renewable electricity for
                            their homes.
                          </p>
                        </div>
                        <div className="row">
                  ...
                  >
                    ...
                    <div className="row">
                      <div className="col-lg-6">
                        <div className="inner-content-service-right-solari">
                          <h3 className="title">Electric Vehicle Services</h3>
                          <p className="disc">
                            Green Power Systems is proudly established to The
                            assemble, sell, distribute, maintain, support, and
                            promote the use of electric vehicles (EV). Green
                            Power Systems continued efforts are to identify ways
                            to become a more sustainable and profitable company.
                          </p>
                          <p className="disc">
                            It has undertaken a feasibility study to examine
                            ways it can assemble, sell, distribute, maintain,
                            support, and promote the use of electric vehicles
                            (EV).
                          </p>
                        </div>
                        <div className="row">
                  ...
                  >
                    ...
                    <div className="row">
                      <div className="col-lg-6">
                        <div className="inner-content-service-right-solari">
                          <h3 className="title">Tire and Cable Services</h3>
                          <p className="disc">
                            Green Power Systems offers comprehensive tire and
                            cable solutions for industrial, commercial, and
                            utility applications. Our services include supply,
                            installation, maintenance, and repair of
                            high-quality tires and cables, ensuring durability,
                            safety, and optimal performance.
                          </p>
                          <p className="disc">
                            We focus on reliable products and expert service to
                            minimize downtime, enhance operational efficiency,
                            and support long-term performance for your equipment
